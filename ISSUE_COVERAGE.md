...
| Native / node-pty / generic CLI growth | `#32760`, `#33673`, `#34652`, `#25023`, `#33735`, `#17615` | 30-second growth detection + sustained absolute memory ceiling | `PARTIAL` | Still reactive; no native-memory root-cause fix exists locally |
